...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) 
            ...
            if (($password == $confirm_password) && (!preg_match("#.*^(?=.{8,20})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*\W).*$#", $password))) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'naaf906@gmail.com';                     //SMTP username
                        $mail->Password   = 'qdkuoxwmghgbsyfc';                               //SMTP password
                        $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
                        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
                            
                        //Recipients
                        $mail->setFrom('naaf906@gmail.com','WORD GAME');
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="password" class="password" name="password" placeholder="Enter Your Password" value="<?php if (isset($_POST['submit'])) { echo $password; } ?>" required>
